...
INSERT INTO `admin_passwords` VALUES (1,1,'699f3fd2f403043d11243677b4491a1bd7796de1356e9e452d330a93d2c51235:cOQpj528B9QfygCp:2',0,1616239225);
...
INSERT INTO `admin_user` VALUES (1,'admin','admin','admin@admin.com','admin','699f3fd2f403043d11243677b4491a1bd7796de1356e9e452d330a93d2c51235:cOQpj528B9QfygCp:2','2021-03-20 11:20:25','2021-11-27 20:53:33','2021-11-27 20:53:33',1,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL,NULL);
...
INSERT INTO `admin_user_session` VALUES (1,'1f9391df2c77bb613cb1e0ed5e460613',1,1,'2021-11-27 20:53:33','2021-11-27 20:53:33','172.18.0.1');
...
INSERT INTO `adminnotification_inbox` VALUES (1,4,'2021-03-20 11:20:24','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System test.','',0,0);
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2021-03-20 11:20:22','2021-03-20 11:20:22','1',0,0,1),(2,3,1,'2021-03-20 11:20:22','2021-03-20 11:20:22','1/2',1,1,0);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Product Price Indexer test Option Aggregate Index Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalog_product_index_price_cfg_opt_agr_tmp` (
  ...
  `tier_price` decimal(20,6) DEFAULT NULL COMMENT 'Tier Price',
  PRIMARY KEY (`parent_id`,`child_id`,`customer_group_id`,`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Product Price Indexer test Option Aggregate Temp Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalog_product_index_price_cfg_opt_idx` (
  ...
  `tier_price` decimal(20,6) DEFAULT NULL COMMENT 'Tier Price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Product Price Indexer test Option Index Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalog_product_index_price_cfg_opt_tmp` (
  ...
  `tier_price` decimal(20,6) DEFAULT NULL COMMENT 'Tier Price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalog Product Price Indexer test Option Temp Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cataloginventory_stock_item` (
  ...
  `use_config_min_qty` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Min Qty',
  `is_qty_decimal` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Is Qty Decimal',
  `backorders` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Backorders',
  `use_config_backorders` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Backorders',
  `min_sale_qty` decimal(12,4) NOT NULL DEFAULT '1.0000' COMMENT 'Min Sale Qty',
  `use_config_min_sale_qty` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Min Sale Qty',
  `max_sale_qty` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Max Sale Qty',
  `use_config_max_sale_qty` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Max Sale Qty',
  `is_in_stock` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Is In Stock',
  `low_stock_date` timestamp NULL DEFAULT NULL COMMENT 'Low Stock Date',
  `notify_stock_qty` decimal(12,4) DEFAULT NULL COMMENT 'Notify Stock Qty',
  `use_config_notify_stock_qty` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Notify Stock Qty',
  `manage_stock` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Manage Stock',
  `use_config_manage_stock` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Manage Stock',
  `stock_status_changed_auto` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Stock Status Changed Automatically',
  `use_config_qty_increments` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Qty Increments',
  `qty_increments` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Qty Increments',
  `use_config_enable_qty_inc` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Use test Enable Qty Increments',
...
CREATE TABLE `core_config_data` (
  `config_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'test ID',
  `scope` varchar(8) NOT NULL DEFAULT 'default' COMMENT 'test Scope',
  `scope_id` int(11) NOT NULL DEFAULT '0' COMMENT 'test Scope ID',
  `path` varchar(255) NOT NULL DEFAULT 'general' COMMENT 'test Path',
  `value` text COMMENT 'test Value',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated At',
  PRIMARY KEY (`config_id`),
  UNIQUE KEY `CORE_CONFIG_DATA_SCOPE_SCOPE_ID_PATH` (`scope`,`scope_id`,`path`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='test Data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'catalog/search/elasticsearch7_server_hostname','elasticsearch','2021-03-20 11:20:19'),(2,'default',0,'catalog/search/elasticsearch7_server_port','9200','2021-03-20 11:20:19'),(3,'default',0,'catalog/search/elasticsearch7_enable_auth','0','2021-03-20 11:20:19'),(4,'default',0,'web/seo/use_rewrites','1','2021-03-20 11:20:19'),(5,'default',0,'web/unsecure/base_url','http://formation.devo/','2021-03-20 11:20:19'),(6,'default',0,'general/locale/code','fr_FR','2021-03-20 11:20:19'),(7,'default',0,'general/locale/timezone','Europe/Paris','2021-03-20 11:20:19'),(8,'default',0,'currency/options/base','EUR','2021-03-20 11:20:19'),(9,'default',0,'currency/options/default','EUR','2021-03-20 11:20:19'),(10,'default',0,'currency/options/allow','EUR','2021-03-20 11:20:19'),(11,'default',0,'general/region/display_all','1','2021-03-20 11:20:20'),(12,'default',0,'general/region/state_required','AU,BG,BR,CA,CH,CN,CO,EE,ES,HR,IN,IT,LT,LV,MX,PL,RO,US','2021-03-20 11:20:21'),(13,'default',0,'catalog/category/root_id','2','2021-03-20 11:20:22'),(14,'default',0,'analytics/subscription/enabled','1','2021-03-20 11:20:24'),(15,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2021-03-20 11:20:24'),(16,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2021-03-20 11:20:24'),(17,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2021-03-20 11:20:24'),(18,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2021-03-20 11:20:24'),(19,'default',0,'twofactorauth/duo/application_key','FZcBEFJLdL0ef5rqg5Z1iSexSj7eMeWDg2MkJpF7ebalExeFCvvCfbIqHGkSgcfB','2021-03-20 11:20:24'),(20,'website',0,'connector_configuration/transactional_data/order_statuses','canceled,closed,complete,fraud,holded,payment_review,paypal_canceled_reversal,paypal_reversed,pending,pending_payment,pending_paypal,processing','2021-03-20 11:20:24'),(21,'website',0,'connector_configuration/catalog_sync/catalog_type','simple,virtual,downloadable,configurable,grouped,bundle','2021-03-20 11:20:24'),(22,'website',0,'connector_configuration/catalog_sync/catalog_visibility','1,2,3,4','2021-03-20 11:20:24'),(23,'default',0,'connector_dynamic_content/external_dynamic_content_urls/passcode','zh0hcEuhBg2o9duvZDr3Hk973xXKgb2s','2021-03-20 11:20:24'),(24,'default',0,'connector_automation/review_settings/allow_non_subscribers','1','2021-03-20 11:20:24'),(25,'default',0,'connector_configuration/abandoned_carts/allow_non_subscribers','1','2021-03-20 11:20:24'),(26,'default',0,'sync_settings/addressbook/allow_non_subscribers','1','2021-03-20 11:20:24'),(27,'default',0,'connector_developer_settings/system_alerts/user_roles','1','2021-03-20 11:20:24'),(28,'default',0,'web/secure/base_url','https://formation.devo/','2021-11-27 20:51:13'),(29,'default',0,'web/secure/use_in_adminhtml','1','2021-11-27 20:53:05');
...
INSERT INTO `flag` VALUES (1,'analytics_link_attempts_reverse_counter',0,'24','2021-03-20 11:20:24'),(2,'config_hash',0,'{\"system\":\"2be88ca4242c76e8253ac62474851065032d6833\"}','2021-11-27 20:51:13');
...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','valid','2021-03-20 11:20:25','977948d60ece3081f6c5b7265b0e5bf7'),(2,'customer_grid','valid','2021-03-20 11:20:25','afdd6bac67e087e9a2985fccec2b46c1'),(3,'catalog_category_product','invalid','2021-03-20 11:20:22','1d496fcae142b44dd9c8a0caf3e669d5'),(4,'catalog_product_category','invalid','2021-03-20 11:20:22','a4788d0f5dfeb17a52ea9cfab3c6cd91'),(5,'catalogrule_rule','invalid','2021-03-20 11:20:22','311ccfe1bc302706de196ecd98628ba1'),(6,'catalog_product_attribute','invalid','2021-03-20 11:20:22','cab6862e5c8a738946f76484d3507ee5'),(7,'cataloginventory_stock','invalid','2021-03-20 11:20:22','290509fe6d6bc9acd60cae7503a56468'),(8,'inventory','invalid','2021-03-20 11:20:22','c829d0fcc648a0acf6824c06925724e0'),(9,'catalogrule_product','invalid','2021-03-20 11:20:22','4b47a01072e88f3b90bb117c19e819f4'),(10,'catalog_product_price','invalid','2021-03-20 11:20:22','d545f0a920f9d7f6b0841395d9df0b1b'),(11,'catalogsearch_fulltext','invalid','2021-03-20 11:20:22','eba1cc4fb2d921fbf908dbe154b6596c');
...
INSERT INTO `queue_poison_pill` VALUES ('version-61a29ab1c1878');
...
INSERT INTO `setup_module` VALUES ('Amazon_Core','4.0.4','4.0.4'),('Amazon_Login','4.0.4','4.0.4'),('Amazon_Payment','4.0.4','4.0.4'),('Dotdigitalgroup_Chat','1.2.0','1.2.0'),('Dotdigitalgroup_Email','4.8.0','4.8.0'),('Klarna_Core','6.0.2','6.0.2'),('Klarna_Kp','7.1.0','7.1.0'),('Klarna_KpGraphQl','0.9.0','0.9.0'),('Klarna_Onsitemessaging','1.0.2','1.0.2'),('Klarna_Ordermanagement','6.0.3','6.0.3'),('Magento_GoogleShoppingAds','4.0.1','4.0.1'),('Magento_Securitytxt','1.0.0','1.0.0'),('PayPal_Braintree','4.0.3','4.0.3'),('Vertex_AddressValidation','100.5.0','100.5.0'),('Yireo_Whoops','0.0.11','0.0.11');
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/blank','Magento Blank','preview_image_6055da75a3882.jpeg',0,'frontend',0,'Magento/blank'),(2,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),(3,1,'Magento/luma','Magento Luma','preview_image_6055da75b4609.jpeg',0,'frontend',0,'Magento/luma');
...
-- Dump completed on 2021-11-27 20:58:00
